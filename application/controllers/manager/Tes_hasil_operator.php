...
class Tes_hasil_operator extends Member_Controller {
    ...
    public function index($page=null, $id=null){
		...
		$query_token = $this->tes_token_model->get_by_user_now($user_id);
		$token = '';
    ...
    function get_datatable(){
		...
		$query = $this->tes_user_model->get_datatable_operator($start, $rows, $token);
		$iFilteredTotal = $query->num_rows();
		
		$iTotal= $this->tes_user_model->get_datatable_operator_count($token)->row()->hasil;
