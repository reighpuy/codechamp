    ...
    <div class="wrapper">
        ...
        <nav class="navbar navbar-static-top">
          <div class="container">
            <div class="navbar-header">
              <a href="<?php echo base_url(); ?>" class="navbar-brand"> <b><?php if(!empty($site_names)){ echo $site_names; } ?></b></a>
            </div>
                ...
                <ul class="nav navbar-nav">
                  ...
                  <li class="dropdown user user-menu">
                    ...
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                      ...
                      <!-- hidden-xs hides the username on small devices so only the image appears. -->
                      <span class="hidden-xs"><?php if(!empty($nama)){ echo $nama; }else{ echo 'User'; } ?></span>
                    </a>
                    <?php endforeach; ?>
                    <ul class="dropdown-menu">
                      ...
                      <li class="user-header" style="max-height: 90px;">
                        <p>
                          <?php if(!empty($nama)){ echo $nama; }else{ echo 'User'; } ?>
                          <?php if(!empty($group)){ echo '<br/><span style="color: lightgreen;">Tipe</span> : '.$group; } ?>
                        </p>
                      </li>
                      <!-- Menu Footer-->
      ...
      <footer class="main-footer no-print">
        <!-- <div class="pull-right hidden-xs">
          <?php if(!empty($nama)){ echo $nama; } ?> | <strong> <a href="<?php echo site_url(); ?>/auth/logout" >Log out</a></strong>
        </div> -->
        <div class="container">
