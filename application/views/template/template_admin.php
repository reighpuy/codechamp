    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="<?php echo site_url(); ?>/manager" class="logo">
          ...
          <span class="logo-lg"><b>Codechamp</b></span>
        </a>
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-footer">
                    ...
                    <div class="pull-right">
                      <a href="<?php echo site_url(); ?>/manager/auth/logout" class="btn btn-default btn-flat">Sign out</a>
                    </div>
                  </li>
                </ul>
              </li>
    ...
    <div class="modal" id="modal-proses" data-backdrop="static">
  		<div class="modal-dialog">
            ...
            <div style="text-align: center;">
              <img width="200" src="<?php echo base_url(); ?>public/images/vestia-zeta.gif" /> <br />Mohon tunggu sebentar...
            </div>
            <br />
