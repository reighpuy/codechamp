...
<section class="content-header">
    <h1>
        Daftar Soal
        <small>Daftar soal dan jawaban berdasarkan Kategori</small>
    </h1>
    <ol class="breadcrumb">
        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header with-border">
                    <div class="box-title">Pilih Kategori</div>
                </div>
                ...
                <div class="box-footer">
                    <p>Pilih terlebih dahulu Kategori yang akan digunakan sebelum menambah atau mengubah soal</p>
                </div>
            </div>
        </div>
    </div>
