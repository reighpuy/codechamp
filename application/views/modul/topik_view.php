...
<section class="content-header">
    <h1>
        Kategori
        <small>Daftar kategori, penambahan kategori, pengubahan kategori, dan penghapusan kategori berdasarkan Modul</small>
    </h1>
    <ol class="breadcrumb">
        ...
        <div class="col-md-3" hidden>
            <div class="box">
                ...
                <div class="box-footer">
                    <p>Pilih modul terlebih dahulu untuk menampilkan dan menambah kategori</p>
                </div>
            </div>
        </div>
                ...
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                        <div class="dropdown pull-right">
                            <a style="cursor: pointer;" onclick="tambah()">Tambah Kategori</a>
                        </div>
                    </div>
                </div><!-- /.box-header -->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div id="trx-judul">Tambah Kategori</div>
                </div>
                    ...
                    <div class="row-fluid">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="tambah-topik" name="tambah-topik" placeholder="Nama Kategori">
                            </div>

                            <div class="form-group">
                                <label>Deskripsi</label>
                                <input type="text" class="form-control" id="tambah-deskripsi" name="tambah-deskripsi" placeholder="Deskripsi Kategori">
                            </div>
    ...
    <div class="modal" id="modal-edit" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="basicModal" aria-hidden="true">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button class="close" type="button" data-dismiss="modal">&times;</button>
                    <div id="trx-judul">Edit Kategori</div>
                </div>
                <div class="modal-body">
                    <div class="row-fluid">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="edit-topik" name="edit-topik" placeholder="Nama Kategori">
                            </div>
                            <div class="form-group">
                                <label>Deskripsi</label>
                                <input type="text" class="form-control" id="edit-deskripsi" name="edit-deskripsi" placeholder="Deskripsi Kategori">
                            </div>
                            <div class="form-group">
                                <label>Status</label>
                                <input type="text" class="form-control" id="edit-status" name="edit-status" value="AKTIF" readonly>
                            </div>
                            <p>NB : Kategori yang dihapus, maka semua bank soal akan ikut terhapus !</p>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
    ...
    <div class="modal" id="modal-hapus" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="basicModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button class="close" type="button" data-dismiss="modal">&times;</button>
                    <div id="trx-judul">Hapus Kategori</div>
                </div>
                <div class="modal-body">
                    <div class="row-fluid">
                        <div class="box-body">
                            <strong>Peringatan</strong>
                            Data Kategori yang sudah dipilih akan dihapus beserta isi soal didalamnya.
                            <br /><br />
                            Apakah anda yakin untuk menghapus data Kategori ?
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
