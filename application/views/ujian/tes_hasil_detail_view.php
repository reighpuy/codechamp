<div class="container">
	...
	<section class="content-header">
		<h1>
			Detail hasil pengerjaan materi
			<small>Detail setiap pengguna.</small>
		</h1>
		<ol class="breadcrumb">
			<li><a href="<?php echo site_url(); ?>/">Home</a></li>
			<li class="active">Detail hasil pengerjaan materi</li>
		</ol>
	</section>
			...
			<div class="col-xs-12">
				<div class="box">
					<div class="box-header with-border">
						<div class="box-title">Informasi hasil pengerjaan</div>
					</div><!-- /.box-header -->
