	...
	<section class="content">
		...
		<div class="row">
			<div class="login-box">
				...
				<center><span>Belum memiliki akun ?</span> <a href="<?php echo site_url(); ?>/auth/register">Daftarkan akun</a><br /><a href="<?= base_url('beranda'); ?>">Kembali ke halaman beranda</a></center>
			</div>
	</section><!-- /.content -->
</div><!-- /.container -->
