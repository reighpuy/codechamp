        ...
        <div class="col-md-6">
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <p>Klik tombol <b>Backup Data Upload</b> untuk melakukan Backup Data yang di Upload (gambar). Simpan backup data pada tempat yang aman.</p>
	...
	<div class="row">
		<div class="col-md-6">
                <div class="box">
                    ...
                    <div class="box-body">
                        <span id="form-pesan-database"></span>
                        <p>Klik tombol <b>Clear Sessions</b> untuk membersihkan sessions peserta tes yang disimpan di tabel sessions.</p>
                        <p>Setelah Codechamp digunakan dalam waktu yang lama dan menjalan banyak TES, maka session harus dibersikan.</p>
