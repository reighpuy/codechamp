...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light nav-colour" id="nav">
        <div class="container">
            <img src="<?= base_url('assets/'); ?>img/codechamplogo2.png" class="navbar-brand" width="40" alt="">
            ...
            <div class="collapse navbar-collapse nav-colour" id="navbarNav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li>
                    <li class="nav-item">
                        <a class="cta text-decoration-none" href="<?= site_url('auth/register') ?>">
                            <span class="my-auto">
                                <span class="font-daftar-masuk">Daftar</span>
                            </span>
                        </a>
                    </li>
                </ul>
