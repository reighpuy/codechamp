...
class soal_model extends CI_Model{
    ...
    function get_by_topik_tipe_kesulitan_select_limit($topik, $tipe, $kesulitan, $select, $limit){
        ...
        $sql = 'SELECT '.$select.' FROM soal WHERE soal_topik_id="'.$topik.'" AND soal_difficulty="'.$kesulitan.'" '.$tipe_sql.' ORDER BY RAND() LIMIT '.$limit;
    ...
    function get_by_topik_tipe_kesulitan_select_limit_tanpa_acak($topik, $tipe, $kesulitan, $select, $limit){
        ...
        $sql = 'SELECT '.$select.' FROM soal WHERE soal_topik_id="'.$topik.'" AND soal_difficulty="'.$kesulitan.'" '.$tipe_sql.' ORDER BY soal_id ASC LIMIT '.$limit;
