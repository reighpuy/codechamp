...
class jawaban_model extends CI_Model{
    ...
    function get_by_soal_limit($soal, $limit){
        $sql = '(SELECT jawaban_id FROM jawaban WHERE jawaban.jawaban_soal_id='.$soal.' AND jawaban.jawaban_benar=1 LIMIT 1) UNION (SELECT jawaban_id FROM jawaban WHERE jawaban.jawaban_soal_id='.$soal.' AND jawaban.jawaban_benar=0 LIMIT '.($limit-1).') ORDER BY RAND();';
